...
namespace crv {
	namespace graphics {
		...
		public:
			...
			[[nodiscard]] virtual std::unique_ptr<CRV_Color> GetPixelColor(int x, int y) const = 0;
			[[nodiscard]] virtual std::unique_ptr<CRV_Color> GetPixelColor(float x, float y) const = 0;
